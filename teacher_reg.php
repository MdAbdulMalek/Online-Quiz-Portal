...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			 <div class="panel panel-danger">
				  ...
				  <div class="panel-body"><center><h3>Teacher Registration Form</h3></center></div>
			</div>
		</div>
    </div>
	...
	<div class="col-sm-12">
			...
			<?php 
							...
							?>
	  <form role="form" method="post" action="reg_teacher.php" enctype="multipart/form-data"  >
								...
								<center><input name="submit" type="submit" id="lol" value="Submit "></input>
                                 <a href="login_teacher.php"><input name="reg" type="button" id="lol" value="Login Page "></input></a>
